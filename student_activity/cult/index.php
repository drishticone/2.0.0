...
<div class="panel panel-default hoverable">
  <div class="panel-body">
  <div class="col-md-5">
  <img src="../cult/image/cult.jpg" width="90" height="90"></div></br></br>
...
<ul class="nav nav-tabs" role="tablist" id="myTab">
  <!--<li class="active"><a href="#about" role="tab" data-toggle="tab"><center>About</a></li>-->
  <!-- <li><a href="#activity" role="tab" data-toggle="tab">Sign Up</a></li> -->
  </ul>
  
 <center><p class="title2"><span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span>&nbsp;&nbsp;Cultural Council</p></center>
 <hr>


  <div id="about" style="padding:10px"><p>
Do you think you can hit high notes? Do you have that hidden MJ, Madhuri, Shakira in you? Do these lines excite you “Bade bade shehron mein aisi chhoti chhoti batein…….”.Do you feel your voice can allure the audience ?then cultural council is your new home .This college council organises a plethora of events throughout the year. It provides the student profuse platform to hone their skill like singing, instruments playing, dancing mimicry, skit performance and anchoring. This council gives opportunities to the students to cement them into the cultural scene through varied events throughout the year.</br>
</br> <b>Convener -Prof. Ruchin Agarwal, Civil Engineering Department.
</b>
</p>
