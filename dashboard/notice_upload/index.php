...
<title>Drishticone || Notice Upload</title>
...
<img style="margin-top:-60px;" src="../image/logo1.gif" height="90" />
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li> <a  href="#"><span class="glyphicon glyphicon-cloud-upload" aria-hidden="true"></span>Notice&nbsp;Upload</a></li>
...
<div class="panel panel-default">
  <div class="panel-body">
   <center><p class="title1"><span class="glyphicon glyphicon-cloud-upload" aria-hidden="true"></span>&nbsp;&nbsp;Notice&nbsp;Upload</p></center>
   <?php if(@$_GET['w'])
   {
  ...
  <div class="form-group">
    ...
    <input type="text" name="title" class="form-control" id="title" placeholder="Enter title of notice" required>
  </div>
 <div class="form-group">
    <label for="file">Upload&nbsp;File</label>
    <input type="file" id="file" name="fileToUpload" style="color:#1d9d72;" required><br />
    <p class="help-block"><span class="glyphicon glyphicon-hand-right" aria-hidden="true"></span>&nbsp;&nbsp;Only .pdf or .docx/.doc format is allowed.</p>
  </div>
