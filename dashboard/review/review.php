...
<form method="post" action="upload.php?aid='.$aid.'" enctype="multipart/form-data">
...
<select id="type" name="type" placeholder="Select Category of article" class="form-control input-md" >
   <option value="#">Change category of article</option>';
...
<textarea class="form-control ckeditor" id="editor" name="article">'.$article.'</textarea>
</div>


  
  
<center><button type="submit" class="btn btn-primary sub hoverable" style="background:#1d9d74; border-radius:0px;">Post&nbsp;to&nbsp;Website&nbsp;&nbsp;<span class="glyphicon glyphicon-flag" aria-hidden="true"></span></button></center>
</form>';
?>
